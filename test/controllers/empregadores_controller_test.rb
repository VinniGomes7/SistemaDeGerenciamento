...
class EmpregadoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empregador" do
    ...
    assert_redirected_to empregadore_url(Empregador.last) # Alterado
  end

  test "should show empregador" do
    get empregadore_url(@empregador) # Alterado
    assert_response :success
  end

  test "should update empregador" do
    patch empregadore_url(@empregador), params: { empregador: { nome: "Atualizado", email: "atualizado@empresa.com" } } # Alterado
    assert_redirected_to empregadore_url(@empregador) # Alterado
  end

  test "should destroy empregador" do
    assert_difference('Empregador.count', -1) do
      delete empregadore_url(@empregador) # Alterado
    end
